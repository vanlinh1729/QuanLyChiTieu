$(function () {
    ...
    var service = quanLyChiTieuCaNhan.categories.category;
    ...
    var dataTable = $('#CategoryTable').DataTable(abp.libs.datatables.normalizeConfiguration({
        ...
        columnDefs: [
                ...
                rowAction: {
                    items:
                        [
                            {
                                text: l('Edit'),
                                visible: abp.auth.isGranted('QuanLyChiTieuCaNhan.Category.Update'),
                            ...
                            {
                                text: l('Delete'),
                                visible: abp.auth.isGranted('QuanLyChiTieuCaNhan.Category.Delete'),
            ...
            {
                title: l('CategoryTotalMoney'),
                data: "totalMoney"
            },
            {
                title: l('CategoryWalletId'),
                data: "walletId"
            },
            {
                title: l('CategoryCategoryType'),
                data: "categoryType"
            },
        ]
    }));
